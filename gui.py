...
#比赛信息标签
round_label = ctk.CTkLabel(root,text="第 0 局",font=ctk.CTkFont(size=14))
...
#比赛重置按钮
def Reset_Match():
    global match_round,player_match_wins,computer_match_wins,game_over
...
reset_btn = ctk.CTkButton(root,text="🔄 重新比赛",command=Reset_Match,width=120)
